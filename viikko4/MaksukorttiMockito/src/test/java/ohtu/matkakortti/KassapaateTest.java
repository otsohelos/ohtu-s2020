...
public class KassapaateTest {
  ...
  @Test
  public void lataaLisaaRahaaJosSummaOnPositiivinen() {
    int summa = 10;
    kassa.lataa(kortti, summa);

    verify(kortti, times(1)).lataa(summa);
  }

  @Test
  public void lataaEiLisaaRahaaJosSummaOnNegatiivinen() {
    int summa = -10;
    kassa.lataa(kortti, summa);

    verify(kortti, times(0)).lataa(summa);
  }
